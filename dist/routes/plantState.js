...
router.get('/:plant_id', plantStateController.getPlantState.bind(plantStateController));
router.put('/:plant_id', plantStateController.updatePlantState.bind(plantStateController));
