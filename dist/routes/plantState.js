...
router.get('/:plant_id', plantStateController.getPlantState);

// POST /api/plants/:plant_id/experience - 경험치 획득
router.post('/:plant_id/experience', plantStateController.gainExperience);

// POST /api/plants/:plant_id/likeability - 호감도 증가
router.post('/:plant_id/likeability', plantStateController.increaseLikeability);
