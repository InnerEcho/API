...
export declare abstract class BaseChatBot {
     ...
     * 5. 대화 결과 저장 및 반환
     */
    processChat(userId: number, plantId: number, userMessage: string): Promise<String>;
    /**
     * 🌱 프롬프트 생성 메서드 (하위 클래스에서 반드시 구현)
     * @param plantDbInfo - 사용자와 식물 정보
     * @param userMessage - 사용자 입력 메시지
     */
    protected abstract createPrompt(plantDbInfo: PlantDbInfo, userId: number, plantId: number, userMessage: string): Promise<Array<[string, string]>>;
}
